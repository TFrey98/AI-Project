"""Recompute and export the registered Phase 36c decision."""
...
try:
    ...
    from phase36c_begin_only_identity_invariance_decision import (  # type: ignore
        begin_only_identity_invariance_decision,
    )
...
def main() -> None:
    ...
    decision = begin_only_identity_invariance_decision(
    ...
    if decision["branch"] != "begin_only_identity_invariance_diagnostic_pass":
        raise SystemExit(1)
